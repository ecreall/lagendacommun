...
class SeePromotionServiceView(BasicView):
    title = ''
    name = 'seepromotionservice'
    behaviors = [SeePromotionService]
    template = 'lac:views/services_processes/promotion_service/templates/see_promotion_service.pt'
    viewid = 'seepromotionservice'
...
DEFAULTMAPPING_ACTIONS_VIEWS.update(
    {SeePromotionService: SeePromotionServiceView})
