...
class DoubloonVenueViewStudyReport(BasicView):
    title = 'Alert for remove'
    name = 'alertforremove'
    template = 'lac:views/venue_management/templates/alert_doubloon.pt'
    ...
    def update(self):
        ...
        duplicates = find_duplicates_venue(self.context, self.duplicates_state)
        diff_bodies = {}
...
class DoubloonVenueView(FormView):
    title = _('Remove')
...
@view_config(
    name='potentialduplicatesvenue',
    context=Venue,
    renderer='pontus:templates/views_templates/grid.pt',
    )
class DoubloonVenueViewMultipleView(MultipleView):
    title = _('Duplicate detection')
    name = 'potentialduplicatesvenue'
    viewid = 'potentialduplicatesvenue'
    template = 'daceui:templates/mergedmultipleview.pt'
    views = (DoubloonVenueViewStudyReport, DoubloonVenueView)
    validators = [ManageDuplicates.get_validator()]


DEFAULTMAPPING_ACTIONS_VIEWS.update(
    {ManageDuplicates: DoubloonVenueViewMultipleView})
